...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.bandwith = bandwith = samp_rate / 10
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_bandwith(self.samp_rate / 10)
        self.analog_sig_source_x_0.set_sampling_freq(self.samp_rate)
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, (self.F - self.bandwith / 2), (self.F + self.bandwith / 2), 1e2, window.WIN_HAMMING, 6.76))
